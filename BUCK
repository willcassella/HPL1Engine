cxx_library(
    ...
    srcs = [
        ...
        "sources/impl/OpenALSoundChannel.cpp",
        "sources/impl/OpenALSoundData.cpp",
        "sources/impl/OpenALSoundEnvironment.cpp",
        "sources/impl/PBuffer.cpp",
        ...
        "sources/impl/SDLBitmap2D.cpp",
        "sources/impl/SDLFontData.cpp",
        "sources/impl/SDLGameSetup.cpp",
        "sources/impl/SDLTexture.cpp",
        "sources/impl/SqScript.cpp",
        "sources/impl/VertexBufferOGL.cpp",
        "sources/impl/VertexBufferVBO.cpp",
        "sources/impl/VideoStreamTheora.cpp",
        "sources/impl/platform/posix.cpp",
        #"sources/impl/platform/win32.cpp",
        "sources/impl/scriptstring.cpp",
        "sources/impl/stdstring.cpp",
        "sources/impl/tinyXml/tinystr.cpp",
        "sources/impl/tinyXml/tinyxml.cpp",
        "sources/impl/tinyXml/tinyxmlerror.cpp",
        "sources/impl/tinyXml/tinyxmlparser.cpp",
        ...
        "sources/system/Container.cpp",
        "sources/system/LogicTimer.cpp",
        "sources/system/MemoryManager.cpp",
    ...
    compiler_flags = [
        ...
        "-I./newton-dynamics/newton-3.14/sdk/dgNewton",
        "-isystem",
